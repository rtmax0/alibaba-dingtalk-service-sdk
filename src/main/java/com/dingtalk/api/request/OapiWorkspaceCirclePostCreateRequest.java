...
public class OapiWorkspaceCirclePostCreateRequest extends BaseTaobaoRequest<OapiWorkspaceCirclePostCreateResponse> {
	...
	* 创建动态的入参
	...
	public static class FvDingPanFileContentOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 8791568363344725161L;
		/**
	...
	public static class FvAttachmentsOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 3488941273485378662L;
		/**
		 * 钉盘文件列表
		 */
	...
	public static class FvPhotoOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 7122662449716611732L;
		/**
	...
	public static class FvPhotoContentOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 6188594145974167491L;
		/**
		 * 图片内容列表
		 */
		@ApiListField("photos")
	...
	public static class FvVideoContentOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 6221479695242123534L;
		/**
		 * 视频比特率
		 */
		@ApiField("bitrate")
	...
	public static class FvPostContentOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 4569724799255955423L;
		/**
		 * 附件内容
		 */
	...
	public static class FvPostTagOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 4156422692859189532L;
		/**
		 * 标签名
		 */
		@ApiField("name")
	...
	public static class FvPostCreateOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 2131141792129233942L;
		/**
		 * 动态的内容
		 */
		@ApiField("content")
