...
import com.dingtalk.api.response.OapiCateringAllowanceCapacityGetResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.catering.allowance.capacity.get request
 * 
 * @author top auto create
 * @since 1.0, 2019.11.13
 */
public class OapiCateringAllowanceCapacityGetRequest extends BaseTaobaoRequest<OapiCateringAllowanceCapacityGetResponse> {
	...
	* 点餐人userid
	...
	public Class<OapiCateringAllowanceCapacityGetResponse> getResponseClass() {
		return OapiCateringAllowanceCapacityGetResponse.class;
	}
