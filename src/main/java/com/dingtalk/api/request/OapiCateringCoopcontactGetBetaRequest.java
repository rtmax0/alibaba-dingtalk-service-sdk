...
import com.dingtalk.api.response.OapiCateringCoopcontactGetBetaResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.catering.coopcontact.get.beta request
 * 
 * @author top auto create
 * @since 1.0, 2019.10.31
 */
public class OapiCateringCoopcontactGetBetaRequest extends BaseTaobaoRequest<OapiCateringCoopcontactGetBetaResponse> {
	...
	* 店铺id
	...
	public Class<OapiCateringCoopcontactGetBetaResponse> getResponseClass() {
		return OapiCateringCoopcontactGetBetaResponse.class;
	}
