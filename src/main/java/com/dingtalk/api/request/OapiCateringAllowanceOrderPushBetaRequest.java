...
import com.dingtalk.api.response.OapiCateringAllowanceOrderPushBetaResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.catering.allowance.order.push.beta request
 * 
 * @author top auto create
 * @since 1.0, 2019.11.13
 */
public class OapiCateringAllowanceOrderPushBetaRequest extends BaseTaobaoRequest<OapiCateringAllowanceOrderPushBetaResponse> {
	...
	* 点餐人的编码，通过开放平台获取的 userId
	...
	public Class<OapiCateringAllowanceOrderPushBetaResponse> getResponseClass() {
		return OapiCateringAllowanceOrderPushBetaResponse.class;
	}
