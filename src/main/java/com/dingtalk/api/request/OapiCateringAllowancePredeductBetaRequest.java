...
import com.dingtalk.api.response.OapiCateringAllowancePredeductBetaResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.catering.allowance.prededuct.beta request
 * 
 * @author top auto create
 * @since 1.0, 2019.11.13
 */
public class OapiCateringAllowancePredeductBetaRequest extends BaseTaobaoRequest<OapiCateringAllowancePredeductBetaResponse> {
	...
	* 点餐人userid
	...
	public Class<OapiCateringAllowancePredeductBetaResponse> getResponseClass() {
		return OapiCateringAllowancePredeductBetaResponse.class;
	}
