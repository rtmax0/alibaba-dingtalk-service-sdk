...
public class OapiV2UserUpdateRequest extends BaseTaobaoRequest<OapiV2UserUpdateResponse> {
	...
	* 职位，长度最大200个字符。
	...
	/** 
	* 员工id，长度最大50个字符。员工在当前企业内的唯一标识。如果不传，服务器将自动生成一个userid。创建后不可修改，企业内必须唯一。
	 */
	...
	* 办公地点，长度最大100个字符。
	...
	public static class DeptOrder extends TaobaoObject {
		private static final long serialVersionUID = 4268912124628399453L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class DeptTitle extends TaobaoObject {
		private static final long serialVersionUID = 4666362525162877334L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
