...
import com.dingtalk.api.response.OapiCateringAllowanceCapacityGetBetaResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.catering.allowance.capacity.get.beta request
 * 
 * @author top auto create
 * @since 1.0, 2019.11.13
 */
public class OapiCateringAllowanceCapacityGetBetaRequest extends BaseTaobaoRequest<OapiCateringAllowanceCapacityGetBetaResponse> {
	...
	* 点餐人userid
	...
	public Class<OapiCateringAllowanceCapacityGetBetaResponse> getResponseClass() {
		return OapiCateringAllowanceCapacityGetBetaResponse.class;
	}
