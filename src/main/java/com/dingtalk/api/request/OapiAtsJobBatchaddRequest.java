...
public class OapiAtsJobBatchaddRequest extends BaseTaobaoRequest<OapiAtsJobBatchaddResponse> {
	...
	* 操作人员工标识
	...
	public static class JobExtDataVo extends TaobaoObject {
		private static final long serialVersionUID = 7716762864641787518L;
		/**
		 * 招募人数
		 */
		@ApiField("head_count")
	...
	public static class JobAddressVo extends TaobaoObject {
		private static final long serialVersionUID = 3557571196327114512L;
		/**
		 * 位置详情
		 */
		@ApiField("detail")
	...
	public static class AtsAddJobParam extends TaobaoObject {
		private static final long serialVersionUID = 8662962319964752936L;
		/**
		 * 工作地点
		 */
		@ApiField("address")
