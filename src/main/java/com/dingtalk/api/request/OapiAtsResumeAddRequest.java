...
public class OapiAtsResumeAddRequest extends BaseTaobaoRequest<OapiAtsResumeAddResponse> {
	...
	* 简历文件参数
	...
	public static class EducationInfo extends TaobaoObject {
		private static final long serialVersionUID = 1624469728269361113L;
		/**
		 * 学历
		 */
		@ApiField("education")
	...
	public static class ExperienceInfo extends TaobaoObject {
		private static final long serialVersionUID = 4522526348656648746L;
		/**
		 * 公司名称
		 */
		@ApiField("company")
	...
	public static class TrainingInfo extends TaobaoObject {
		private static final long serialVersionUID = 2515657432784144129L;
		/**
		 * 所获证书
		 */
	...
	public static class ProjectInfo extends TaobaoObject {
		private static final long serialVersionUID = 1394339312729459976L;
		/**
		 * 结束时间
		 */
		@ApiField("end_date")
	...
	public static class ResumeDetailInfo extends TaobaoObject {
		private static final long serialVersionUID = 3158481179735299192L;
		/**
		 * 学位
		 */
	...
	public static class CollResumeMailParam extends TaobaoObject {
		private static final long serialVersionUID = 1749541226643969484L;
		/**
		 * 渠道来源，接入前请提前沟通
		 */
		@ApiField("channel")
