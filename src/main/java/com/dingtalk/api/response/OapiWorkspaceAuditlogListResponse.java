...
public class OapiWorkspaceAuditlogListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7542424124962812672L;
	...
	public static class EventAuditLogDto extends TaobaoObject {
		private static final long serialVersionUID = 5368959553554544572L;
		/**
		 * 操作类型
		 */
		@ApiField("action")
	...
	public static class OpenAuditLogDto extends TaobaoObject {
		private static final long serialVersionUID = 7723213536934815834L;
		/**
		 * 记录列表
		 */
