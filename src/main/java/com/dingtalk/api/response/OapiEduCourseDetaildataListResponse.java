...
public class OapiEduCourseDetaildataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2224639914798492392L;
	...
	public static class CourseDetailDataDTO extends TaobaoObject {
		private static final long serialVersionUID = 8616694173533655665L;
		/**
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 2634321281238391576L;
		/**
		 * 表示是否还有更多的数据
		 */
		@ApiField("has_more")
