...
public class OapiProcessActivityinfoGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3113265781239532191L;
	...
	public static class ActivityModel extends TaobaoObject {
		private static final long serialVersionUID = 2788554265652146688L;
		/**
		 * 节点id
		 */
	...
	public static class ProcessActivityTopVo extends TaobaoObject {
		private static final long serialVersionUID = 2122131426928952653L;
		/**
		 * 节点信息列表
		 */
		@ApiListField("models")
