...
public class OapiKacDatavDeptVideoconfListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5331491415828264813L;
	...
	public static class McsDeptSummaryVo extends TaobaoObject {
		private static final long serialVersionUID = 3849531839321593788L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class McsDeptSummaryResponse extends TaobaoObject {
		private static final long serialVersionUID = 8677217912263211214L;
		/**
		 * data
		 */
		@ApiListField("data")
