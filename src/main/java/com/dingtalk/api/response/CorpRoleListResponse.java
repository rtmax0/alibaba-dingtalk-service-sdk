...
public class CorpRoleListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1561897247937977161L;
	...
	public static class Roles extends TaobaoObject {
		private static final long serialVersionUID = 4657224254632593391L;
		/**
		 * 角色ID
		 */
		@ApiField("id")
	...
	public static class RoleGroups extends TaobaoObject {
		private static final long serialVersionUID = 3278351227433949695L;
		/**
		 * 角色分组名称
		 */
		@ApiField("group_name")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 1528796828976767297L;
		/**
		 * 分页是否还有数据
		 */
		@ApiField("has_more")
