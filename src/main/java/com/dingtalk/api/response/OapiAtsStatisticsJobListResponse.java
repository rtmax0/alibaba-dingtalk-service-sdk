...
public class OapiAtsStatisticsJobListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7226543224294472256L;
	...
	public static class TopJobStatisticsVo extends TaobaoObject {
		private static final long serialVersionUID = 2213886716971187232L;
		/**
		 * 招聘业务标识
		 */
		@ApiField("biz_code")
	...
	public static class AtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 7118696786554629964L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
