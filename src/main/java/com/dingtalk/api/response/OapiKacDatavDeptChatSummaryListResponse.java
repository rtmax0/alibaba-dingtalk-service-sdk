...
public class OapiKacDatavDeptChatSummaryListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6266288856715761118L;
	...
	public static class ImDeptSummaryVo extends TaobaoObject {
		private static final long serialVersionUID = 7761539141681849762L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class ImDeptSummaryResponse extends TaobaoObject {
		private static final long serialVersionUID = 3273485723731826879L;
		/**
		 * data
		 */
		@ApiListField("data")
