...
public class OapiAtsStatisticsResumeListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2269519397986172227L;
	...
	public static class TopResumeStatisticsVo extends TaobaoObject {
		private static final long serialVersionUID = 1539972723111161378L;
		/**
		 * 招聘业务标识
		 */
		@ApiField("biz_code")
	...
	public static class AtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 4217516645724679929L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
