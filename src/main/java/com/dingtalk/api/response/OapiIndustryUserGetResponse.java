...
public class OapiIndustryUserGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8867824827933533899L;
	...
	public static class OpenRole extends TaobaoObject {
		private static final long serialVersionUID = 5144543971539285571L;
		/**
		 * 标签ID
		 */
		@ApiField("id")
	...
	public static class OpenIndustryEmp extends TaobaoObject {
		private static final long serialVersionUID = 3423396244965159821L;
		/**
		 * 员工特征
		 */
		@ApiField("feature")
