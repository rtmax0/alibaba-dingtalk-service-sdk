...
public class OapiWikiGroupListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2345334718975298163L;
	...
	public static class OpenGroupVo extends TaobaoObject {
		private static final long serialVersionUID = 2758257838432873912L;
		/**
		 * 知识库的描述
		 */
		@ApiField("desc")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 2832883374611845869L;
		/**
		 * 组织内知识库列表
		 */
		@ApiListField("data")
