...
public class OapiV2UserListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3737274876722527766L;
	...
	public static class ListUserResponse extends TaobaoObject {
		private static final long serialVersionUID = 2242834955268622914L;
		/**
		 * 是否激活
		 */
		@ApiField("active")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 7455732195822537692L;
		/**
		 * 是否还有更多的数据
		 */
		@ApiField("has_more")
