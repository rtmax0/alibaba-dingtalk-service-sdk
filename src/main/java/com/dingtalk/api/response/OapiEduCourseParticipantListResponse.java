...
public class OapiEduCourseParticipantListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1394261381876539825L;
	...
	public static class CourseParticipantVO extends TaobaoObject {
		private static final long serialVersionUID = 4488275374823484438L;
		/**
		 * 参与方的组织CorpId
		 */
	...
	public static class ListCourseParticipantResponse extends TaobaoObject {
		private static final long serialVersionUID = 5553699232995854548L;
		/**
		 * 表示是否还有更多的数据
		 */
		@ApiField("has_more")
