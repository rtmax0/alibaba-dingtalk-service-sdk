...
public class OapiDingmiGroupGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6255414659942521281L;
	...
	public static class GroupMemberChatData extends TaobaoObject {
		private static final long serialVersionUID = 2448238828692914153L;
		/**
		 * 聊天记录数
		 */
		@ApiField("chat_cnt")
	...
	public static class GroupChatDataResult extends TaobaoObject {
		private static final long serialVersionUID = 3217423119249835858L;
		/**
		 * 是否来自缓存
		 */
		@ApiField("from_cache")
