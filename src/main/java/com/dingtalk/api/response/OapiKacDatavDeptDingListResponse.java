...
public class OapiKacDatavDeptDingListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2192532699384234335L;
	...
	public static class DingUsageDeptSummaryVo extends TaobaoObject {
		private static final long serialVersionUID = 5349173981638619828L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class DingUsageDeptSummaryResponse extends TaobaoObject {
		private static final long serialVersionUID = 6534794884723151639L;
		/**
		 * data
		 */
		@ApiListField("data")
