...
public class OapiEduCourseSummadataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1819255378672766318L;
	...
	public static class CourseSummaryDataDTO extends TaobaoObject {
		private static final long serialVersionUID = 8549183287243143516L;
		/**
		 * 数据类别业务唯一键
		 */
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 7124754642637983631L;
		/**
		 * 表示是否还有更多的数据
		 */
		@ApiField("has_more")
