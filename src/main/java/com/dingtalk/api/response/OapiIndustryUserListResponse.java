...
public class OapiIndustryUserListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1642661441226348171L;
	...
	public static class OpenRole extends TaobaoObject {
		private static final long serialVersionUID = 8631765364116252398L;
		/**
		 * 标签id
		 */
		@ApiField("id")
	...
	public static class OpenIndustryEmp extends TaobaoObject {
		private static final long serialVersionUID = 4692639248539117262L;
		/**
		 * 员工特征
		 */
		@ApiField("feature")
	...
	public static class ResultWrapper extends TaobaoObject {
		private static final long serialVersionUID = 1296286658147126544L;
		/**
		 * 员工列表
		 */
