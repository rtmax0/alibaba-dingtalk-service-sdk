...
public class OapiProcessBizsuiteGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1147464782557456113L;
	...
	public static class FormDataResponseVO extends TaobaoObject {
		private static final long serialVersionUID = 7314775874194813823L;
		/**
		 * 表单组件别名
		 */
		@ApiField("biz_alias")
	...
	public static class BaseSuiteResponse extends TaobaoObject {
		private static final long serialVersionUID = 6816251212146386222L;
		/**
		 * 组件属性值
		 */
