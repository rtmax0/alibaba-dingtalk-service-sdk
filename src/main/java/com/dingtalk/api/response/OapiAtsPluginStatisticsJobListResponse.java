...
public class OapiAtsPluginStatisticsJobListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5864454373852434894L;
	...
	public static class TopJobStatisticsVo extends TaobaoObject {
		private static final long serialVersionUID = 1574149166677676738L;
		/**
		 * 招聘业务标识
		 */
		@ApiField("biz_code")
	...
	public static class AtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 4528613996823852625L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
