...
public class OapiSnsConversationMemberListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8652773499192547145L;
	...
	public static class SnsGroupMemberModel extends TaobaoObject {
		private static final long serialVersionUID = 4511396993686372125L;
		/**
		 * 群昵称
		 */
	...
	public static class SnsOpenGroupMemberResponse extends TaobaoObject {
		private static final long serialVersionUID = 7711157425972184792L;
		/**
		 * 群成员是否还有下页数据
		 */
		@ApiField("has_more")
