...
public class OapiEduUseridGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4871781591573566938L;
	...
	public static class UserIdHold extends TaobaoObject {
		private static final long serialVersionUID = 2655875668735897884L;
		/**
		 * 手机号码
		 */
		@ApiField("mobile")
	...
	public static class OpenEduUserIdListResponse extends TaobaoObject {
		private static final long serialVersionUID = 2344133659288577796L;
		/**
		 * 用户id列表
		 */
		@ApiListField("users")
