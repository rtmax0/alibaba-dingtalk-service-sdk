...
public class OapiEduSubjectMetadataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3873943444587984155L;
	...
	public static class SubjectMetadataDTO extends TaobaoObject {
		private static final long serialVersionUID = 5522697776185246324L;
		/**
		 * 区域编码
		 */
		@ApiField("area_code")
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 7276526287186972655L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
