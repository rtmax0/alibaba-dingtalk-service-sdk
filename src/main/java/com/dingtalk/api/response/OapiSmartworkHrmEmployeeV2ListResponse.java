...
public class OapiSmartworkHrmEmployeeV2ListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1387335817652399666L;
	...
	public static class FieldValueVo extends TaobaoObject {
		private static final long serialVersionUID = 8684579447113691944L;
		/**
		 * 标识第几条明细（下标从0开始）
		 */
		@ApiField("item_index")
	...
	public static class EmpFieldDataVo extends TaobaoObject {
		private static final long serialVersionUID = 7577561475455854473L;
		/**
		 * 字段标识
		 */
		@ApiField("field_code")
	...
	public static class EmpRosterFieldVo extends TaobaoObject {
		private static final long serialVersionUID = 2317243252925762881L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
