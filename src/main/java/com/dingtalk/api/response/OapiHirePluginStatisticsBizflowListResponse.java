...
public class OapiHirePluginStatisticsBizflowListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2344235618588961391L;
	...
	public static class TopBizFlowStatisticsVo extends TaobaoObject {
		private static final long serialVersionUID = 3187184681682946277L;
		/**
		 * 候选人id
		 */
	...
	public static class DdAtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 4495372859258831227L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
