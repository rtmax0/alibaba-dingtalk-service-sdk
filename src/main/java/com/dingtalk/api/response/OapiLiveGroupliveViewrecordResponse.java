...
public class OapiLiveGroupliveViewrecordResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7212681833918587842L;
	...
	public static class UserViewRecordDetailModelList extends TaobaoObject {
		private static final long serialVersionUID = 1137144799545379196L;
		/**
		 * 开始观看时间戳
		 */
	...
	public static class QueryLiveViewRecordDetail extends TaobaoObject {
		private static final long serialVersionUID = 8291364544424563853L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
