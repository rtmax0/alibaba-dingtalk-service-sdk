...
public class OapiAtsPluginStatisticsResumeListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5186561733792844494L;
	...
	public static class TopResumeStatisticsVo extends TaobaoObject {
		private static final long serialVersionUID = 3698437995633292449L;
		/**
		 * 招聘业务标识
		 */
		@ApiField("biz_code")
	...
	public static class AtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 6645579879377539238L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
