...
public class OapiKacDatavTelconfDetailListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7293489274198435478L;
	...
	public static class TelConferenceDetailVo extends TaobaoObject {
		private static final long serialVersionUID = 5363247338528885518L;
		/**
		 * 会议id
		 */
		@ApiField("conf_id")
	...
	public static class TelConferenceDetailResponse extends TaobaoObject {
		private static final long serialVersionUID = 4441645932552866841L;
		/**
		 * data
		 */
		@ApiListField("data")
