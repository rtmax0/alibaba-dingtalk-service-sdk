...
public class OapiWikiRepoListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3222482318684941314L;
	...
	public static class OpenRepoVo extends TaobaoObject {
		private static final long serialVersionUID = 2599392217115797443L;
		/**
		 * 知识库的描述
		 */
		@ApiField("desc")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 5158815936795259416L;
		/**
		 * 知识本列表
		 */
		@ApiListField("data")
