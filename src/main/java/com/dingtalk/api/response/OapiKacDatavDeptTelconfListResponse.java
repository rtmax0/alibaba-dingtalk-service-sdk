...
public class OapiKacDatavDeptTelconfListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5712956414131445944L;
	...
	public static class TelConferenceDeptSummaryVo extends TaobaoObject {
		private static final long serialVersionUID = 5173161694338453693L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class TelConferenceDeptSummaryResponse extends TaobaoObject {
		private static final long serialVersionUID = 8455785411659729497L;
		/**
		 * data
		 */
		@ApiListField("data")
