...
public class OapiV2UserGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2569377964355678176L;
	...
	public static class DeptOrder extends TaobaoObject {
		private static final long serialVersionUID = 1582676747888581977L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class DeptLeader extends TaobaoObject {
		private static final long serialVersionUID = 2157631588346814756L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class UserRole extends TaobaoObject {
		private static final long serialVersionUID = 8729672864874612657L;
		/**
		 * 角色组名称
		 */
		@ApiField("group_name")
	...
	public static class UnionEmpMapVo extends TaobaoObject {
		private static final long serialVersionUID = 4484538671115248332L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
	...
	public static class UnionEmpExt extends TaobaoObject {
		private static final long serialVersionUID = 1486331973985521699L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
	...
	public static class UserGetResponse extends TaobaoObject {
		private static final long serialVersionUID = 5614149576777297343L;
		/**
		 * 是否激活
		 */
		@ApiField("active")
