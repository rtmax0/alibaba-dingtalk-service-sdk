...
public class OapiWikiGroupPublicListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7532759398568259579L;
	...
	public static class OpenGroupVO extends TaobaoObject {
		private static final long serialVersionUID = 6241853333969737258L;
		/**
		 * 知识库的描述
		 */
		@ApiField("desc")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 2369421841668873445L;
		/**
		 * 知识库列表
		 */
		@ApiListField("data")
