...
public class OapiAlitripBtripPriceQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2312694277449535123L;
	...
	public static class HotelFeeDetail extends TaobaoObject {
		private static final long serialVersionUID = 8387587637897233647L;
		/**
		 * 城市
		 */
		@ApiField("city")
	...
	public static class MostExpensive extends TaobaoObject {
		private static final long serialVersionUID = 1495774948386544313L;
		/**
		 * 到达时间
		 */
		@ApiField("arr_time")
	...
	public static class Cheapest extends TaobaoObject {
		private static final long serialVersionUID = 7175183538578454113L;
		/**
		 * 到达时间
		 */
		@ApiField("arr_time")
	...
	public static class BtripRoutes extends TaobaoObject {
		private static final long serialVersionUID = 2181216275554488267L;
		/**
		 * 最低价
		 */
		@ApiField("cheapest")
	...
	public static class TrafficFee extends TaobaoObject {
		private static final long serialVersionUID = 3223722144872938543L;
		/**
		 * 行程费用
		 */
	...
	public static class Module extends TaobaoObject {
		private static final long serialVersionUID = 4246193239176833528L;
		/**
		 * 酒店差标
		 */
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 7262385671221229639L;
		/**
		 * 错误码
		 */
		@ApiField("errcode")
