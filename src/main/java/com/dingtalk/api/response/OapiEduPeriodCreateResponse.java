...
public class OapiEduPeriodCreateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7257871813692835664L;
	...
	public static class EduGradeDo extends TaobaoObject {
		private static final long serialVersionUID = 1778178215155278726L;
		/**
		 * 校区id
		 */
		@ApiField("campus_id")
	...
	public static class OpenPeriodCreateResponse extends TaobaoObject {
		private static final long serialVersionUID = 6652768766443354389L;
		/**
		 * 学段id
		 */
		@ApiField("deptId")
