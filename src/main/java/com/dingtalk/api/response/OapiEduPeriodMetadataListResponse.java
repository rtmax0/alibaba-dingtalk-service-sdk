...
public class OapiEduPeriodMetadataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8392216327843887139L;
	...
	public static class PeriodMetadataDTO extends TaobaoObject {
		private static final long serialVersionUID = 7113642477149675126L;
		/**
		 * 区域编码
		 */
		@ApiField("area_code")
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 1769529159745245164L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
