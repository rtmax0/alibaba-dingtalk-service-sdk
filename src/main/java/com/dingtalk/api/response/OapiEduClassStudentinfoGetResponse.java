...
public class OapiEduClassStudentinfoGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1828639372737672797L;
	...
	public static class OpenPatriarchSelectDto extends TaobaoObject {
		private static final long serialVersionUID = 7761171357464674119L;
		/**
		 * 头像
		 */
		@ApiField("avatar")
	...
	public static class OpenStudentSelectDto extends TaobaoObject {
		private static final long serialVersionUID = 1684443596925571219L;
		/**
		 * 头像
		 */
		@ApiField("avatar")
