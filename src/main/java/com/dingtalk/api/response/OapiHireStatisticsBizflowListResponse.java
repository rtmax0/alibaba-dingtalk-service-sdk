...
public class OapiHireStatisticsBizflowListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6278986755449971467L;
	...
	public static class TopBizFlowStatisticsVo extends TaobaoObject {
		private static final long serialVersionUID = 5693422436931562539L;
		/**
		 * 候选人id
		 */
	...
	public static class DdAtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 3715489325936574711L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
