...
public class OapiImChatScenegroupGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7454769345182812777L;
	...
	public static class ManagementOptions extends TaobaoObject {
		private static final long serialVersionUID = 5581879548436182181L;
		/**
		 * 群禁言，0-默认，不禁言，1-全员禁言
		 */
	...
	public static class DecorationGroupQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 8516829241439199781L;
		/**
		 * 入群链接（需特殊申请才返回）
		 */
		@ApiField("group_url")
