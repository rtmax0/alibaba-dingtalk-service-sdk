...
public class OapiReportTemplateGetbynameResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2737461167641535153L;
	...
	public static class DefaultReceivers extends TaobaoObject {
		private static final long serialVersionUID = 2298857643416251618L;
		/**
		 * 默认接收人名称
		 */
		@ApiField("user_name")
	...
	public static class Fields extends TaobaoObject {
		private static final long serialVersionUID = 7866696642521334858L;
		/**
		 * 模板字段名称
		 */
		@ApiField("field_name")
	...
	public static class BaseConversationVo extends TaobaoObject {
		private static final long serialVersionUID = 8736283751483813831L;
		/**
		 * 默认接收群id
		 */
	...
	public static class ReportTemplateResponseVo extends TaobaoObject {
		private static final long serialVersionUID = 6498183774479346918L;
		/**
		 * 默认接收群
		 */
