...
public class OapiEduTextbookMetadataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8168694728841884655L;
	...
	public static class TextbookMetadataDTO extends TaobaoObject {
		private static final long serialVersionUID = 4819451631652884734L;
		/**
		 * 教材id
		 */
		@ApiField("id")
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 5295965793618754997L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
