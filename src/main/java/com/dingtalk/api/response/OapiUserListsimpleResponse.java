...
public class OapiUserListsimpleResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4555765878543497213L;
	...
	public static class ListUserSimpleResponse extends TaobaoObject {
		private static final long serialVersionUID = 8188148448272951271L;
		/**
		 * 用户姓名
		 */
		@ApiField("name")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 1343576775788381325L;
		/**
		 * 是否还有更多的数据
		 */
		@ApiField("has_more")
