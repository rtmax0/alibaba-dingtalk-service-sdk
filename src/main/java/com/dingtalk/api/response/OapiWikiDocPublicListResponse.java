...
public class OapiWikiDocPublicListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2588837241185739729L;
	...
	public static class OpenDocVo extends TaobaoObject {
		private static final long serialVersionUID = 7689813127746169293L;
		/**
		 * 知识页所在知识库id（加密后的值）
		 */
		@ApiField("group_id")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 5726944111336131115L;
		/**
		 * 知识页列表
		 */
		@ApiListField("data")
