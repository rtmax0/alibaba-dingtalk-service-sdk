...
public class OapiEduSubjectListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3121132979332726178L;
	...
	public static class SubjectInstanceDTO extends TaobaoObject {
		private static final long serialVersionUID = 6699532442566166594L;
		/**
		 * 学段编码
		 */
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 2728381132392931797L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
