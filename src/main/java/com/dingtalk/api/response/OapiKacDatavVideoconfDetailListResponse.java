...
public class OapiKacDatavVideoconfDetailListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5696738829811129121L;
	...
	public static class McsDetailVo extends TaobaoObject {
		private static final long serialVersionUID = 3489533525448128947L;
		/**
		 * 会议id
		 */
		@ApiField("conf_id")
	...
	public static class McsDetailResponse extends TaobaoObject {
		private static final long serialVersionUID = 1769215792565475262L;
		/**
		 * data
		 */
		@ApiListField("data")
