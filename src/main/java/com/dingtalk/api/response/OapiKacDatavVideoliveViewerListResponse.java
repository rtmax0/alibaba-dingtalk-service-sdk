...
public class OapiKacDatavVideoliveViewerListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8366243529478146372L;
	...
	public static class GroupLiveViewer extends TaobaoObject {
		private static final long serialVersionUID = 6125891184282996686L;
		/**
		 * 观看直播时长（毫秒）
		 */
	...
	public static class GroupLiveViewerPageResult extends TaobaoObject {
		private static final long serialVersionUID = 7194593985887941885L;
		/**
		 * 列表数据项
		 */
		@ApiListField("data")
