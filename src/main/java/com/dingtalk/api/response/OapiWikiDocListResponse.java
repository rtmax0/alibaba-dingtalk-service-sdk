...
public class OapiWikiDocListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6145187392499189554L;
	...
	public static class OpenDocVO extends TaobaoObject {
		private static final long serialVersionUID = 2454982627199919242L;
		/**
		 * 知识库ID（加密后的）
		 */
		@ApiField("group_id")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 5116828258283792183L;
		/**
		 * 知识页列表
		 */
		@ApiListField("data")
